...
use GuzzleHttp1\Event\EndEvent;
use GuzzleHttp1\Event\HasEmitterTrait;
use GuzzleHttp1\Pool;
use GuzzleHttp1\Ring\Future\FutureInterface;
use GuzzleHttp1\Ring\Future\FutureValue;
...
abstract class AbstractClient implements ServiceClientInterface
{
    ...
    {
        $cn = 'GuzzleHttp1\\Command\\Exception\\CommandException';
        ...
        if ($transaction->response) {
            ...
            if ($statusCode[0] == '4') {
                $cn = 'GuzzleHttp1\\Command\\Exception\\CommandClientException';
            } elseif ($statusCode[0] == '5') {
                $cn = 'GuzzleHttp1\\Command\\Exception\\CommandServerException';
            }
        }
