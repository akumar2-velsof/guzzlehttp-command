...
use GuzzleHttp1\Event\HasEmitterInterface;
use GuzzleHttp1\ClientInterface;
use GuzzleHttp1\Ring\FutureInterface;
...
interface ServiceClientInterface extends HasEmitterInterface
{
     ...
     *
     * @throws \Exception
     * @see \GuzzleHttp1\Command\ServiceClientInterface::getCommand
     */
     ...
     * @see GuzzleHttp1\Command\ServiceClientInterface::createCommandPool for
     *      a list of options.
     */
