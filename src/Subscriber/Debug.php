...
use GuzzleHttp1\Message\AbstractMessage;
use GuzzleHttp1\Message\MessageInterface;
use GuzzleHttp1\Stream\Stream;
use GuzzleHttp1\Stream\StreamInterface;
...
{
    /** @var \GuzzleHttp1\Stream\StreamInterface */
    private $output;
    private $http;
